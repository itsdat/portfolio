...
function Progress({
  ...
  return (
    <ProgressPrimitive.Root
      data-slot='progress'
      className={cn(
        'bg-primary/20 relative w-full overflow-hidden rounded-full border-[0.5px] h-3',
        isSlim && 'bg-white dark:bg-black border-black dark:border-transparent',
        isOutline &&
    ...
    >
      <ProgressPrimitive.Indicator
        ...
        className={cn(
          'bg-black dark:bg-gray-400 transition-all',
          isSlim
            ? 'absolute top-1/2 -translate-y-[60%] h-[60%] rounded-full'
            : 'h-full',
          indicatorClassName,
        )}
        style={
