...
export default function PixelBackground({
  ...
  const [pixelColors, setPixelColors] = useState(colors);

  useEffect(() => {
    if (theme === "dark") {
      setPixelColors("#f2f0f0,#dedcdc,#fcfcfc");
    } else {
      setPixelColors("#2e2a2a,#1a1414,#454343");
    }
  }, [theme]);
  ...
  useEffect(() => {
    ...
    const initPixels = () => {
      ...
      const colorsArray = pixelColors.split(",");
      const pxs: Pixel[] = [];
  ...
  }, [gap, speed, pixelColors, direction]);
