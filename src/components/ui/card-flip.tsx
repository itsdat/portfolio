        ...
        >
          <div className='relative w-full'>
            <button
              ...
              className='absolute top-4 right-4 p-2 rounded-full hover:bg-white/10 group transition-colors z-10'
            ...
            >
              <Info className='w-5 h-5 text-muted-foreground text-gray-400 group-hover:text-white' />
            </button>
            {front}
          </div>
        </div>
