  ...
  return (
    ...
    >
      <motion.div
        ...
        className="sticky top-2 md:top-6 flex z-1000 items-center justify-between w-full max-w-4xl h-auto py-3 px-3 [@media(min-width:768px)]:px-6 bg-white/80 dark:bg-neutral-950 backdrop-blur-xs border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
      >
        {logoSrc && (
        ...
        <div className="absolute right-3 top-full mt-2 flex flex-col items-center group z-1000">
          <motion.div
          ...
          >
            ...
            {isDragging && dragY > 4 && (
              ...
              >
                {dragY > 8
                  ? `🌟 Release for ${
                      currentGlowPosition === "above" ? "Dark" : "Light"
                    } Mode!`
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              transition={{ duration: 0.2 }}
              className="absolute top-full left-0 right-0 mt-2 [@media(min-width:640px)]:hidden bg-white dark:bg-neutral-950 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg backdrop-blur-xs z-1000"
            >
      ...
      {children && (
        <motion.div
          className="mt-6 [@media(min-width:480px)]:mt-8 w-full flex flex-col justify-center"
